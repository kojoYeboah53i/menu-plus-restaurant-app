...
@section('content')
  <div class="flex justify-center">
    <img src="https://menuplus-dev-921487239036.s3.ap-southeast-2.amazonaws.com/menuplus_images/logos/png/logo_gold_slogan.png" alt="Logo" class="mx-auto img img-fluid mt-5" width="15%">
  </div>
  ...
  <div class="flex justify-center mt-10">
    <form action="{{route('login')}}" method="POST" class="bg-darkAsh-200 px-5 pb-5 w-5/12 rounded-xl">
      <div class="my-4 text-md font-light">Login As Super Admin</div>
      @csrf
