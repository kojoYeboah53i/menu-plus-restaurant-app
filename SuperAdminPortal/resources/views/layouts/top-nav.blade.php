<div class="flex justify-end mb-5">
      <div class="flex space-x-10 items-center mr-2">
                  <i class="fa fa-bell-o top-nav-icon"></i>
                  <i class="fa fa-comment-o top-nav-icon"></i>
                  <i class="fa fa-gift top-nav-icon"></i>
                  <i class="fa fa-life-ring top-nav-icon"></i>
                  ...
                  <div id="top-nav-dropdown" class="dropdown show">
                        ...
                        <div class="dropdown-menu ml-3" aria-labelledby="dropdownMenuLink">
                              ...
                              <form id="selfUploadForm" action="{{route('upload-image')}}" method="POST"  enctype="multipart/form-data">
                                    @csrf
                                    <input type="file" name="profile_pic" onchange="cropImage(this);" id="profileUpload" class="image hidden" enctype="multipart/form-data"/>
                                </form> 
