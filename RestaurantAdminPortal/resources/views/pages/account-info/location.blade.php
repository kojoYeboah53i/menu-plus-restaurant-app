...
@section('content')
      @section('page-title', 'Location Address')
        ...
        <div class="login-inputs text-white">
          <form action="{{route('dashboard.home')}}" method="GET">
            <div class="form-group row" style="margin-bottom: 8px !important;">
              <label for="fullname" class="col-sm-2 col-form-label form-input-label text-left">Shop Number</label>
              <div class="col-sm-10">
                <input type="text" name="fullname" class="form-control login-input" style="margin-bottom: 0px;">
              </div>
            </div>
            <div class="form-group row" style="margin-bottom: 8px !important;">
              <label for="email" class="col-sm-2 col-form-label form-input-label text-left">Street No</label>
              <div class="col-sm-10">
                <input type="email" class="form-control login-input to-input" style="margin-bottom: 0px;">
              </div>
            </div>
            <div class="form-group row" style="margin-bottom: 8px !important;">
              <label for="email" class="col-sm-2 col-form-label form-input-label text-left">Address</label>
              <div class="col-sm-10">
                <input type="tel" class="form-control login-input to-input" style="margin-bottom: 0px;">
              </div>
            </div>
            <div class="form-group row" style="margin-bottom: 8px !important;">
              <label for="email" class="col-sm-2 col-form-label form-input-label text-left">Suburb</label>
              <div class="col-sm-10">
                <input type="tel" class="form-control login-input to-input" style="margin-bottom: 0px;">
              </div>
            </div>
            <div class="form-group row" style="margin-bottom: 8px !important;">
              <label for="email" class="col-sm-2 col-form-label form-input-label text-left">Postcode</label>
              <div class="col-sm-10">
                <input type="tel" class="form-control login-input to-input" style="margin-bottom: 0px;">
              </div>
            </div>
            <div class="form-group row" style="margin-bottom: 8px !important;">
              <label for="email" class="col-sm-2 col-form-label form-input-label text-left">State</label>
              <div class="col-sm-10">
                <input type="tel" class="form-control login-input to-input" style="margin-bottom: 0px;">
              </div>
            </div>
